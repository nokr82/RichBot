  ...
  return (
    <nav className="bg-gray-900 border-b border-gray-700 px-4 py-3 flex items-center justify-between">
      <div className="flex items-center gap-6">
        ...
        <Link href="/all-stocks"  className="text-gray-300 hover:text-white text-sm">전체종목</Link>
        <Link href="/alerts"      className="text-gray-300 hover:text-white text-sm">알림</Link>
